...
return {
  ...
  {
    "yorukot/superfile.nvim",
    event = "User BaseDefered",
    cmd = { "Superfile", "SuperfileToggle", "SuperfileCwd" },
    dependencies = {
    ...
    opts = {
      ...
      floating_window = {
        enabled = true,
        scaling_factor = (is_android and 1.0) or 0.71,
        blend = 0,
      },
      keymaps = {
        ["<CR>"] = "open",
  ...
  -- Remove or comment out the existing Yazi configuration
  -- {
  --   "mikavilpas/yazi.nvim",
  --   ...
  -- },
